...
def loadisos():
    ...
    All inputs are listed in the input file to make things easier and because they are referenced elsewhere.
...
def initrange(p):
    ...
    -------
    errs : ndarray
        The standard deviation to use in each parameter for MCMC walker initialization.
    """
    if len(p) == 14:
