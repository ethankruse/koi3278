...
labels = ['$P$ (days)', '$t_{tran}$ (days)', '$e\cos\omega$', '$e\sin\omega$',
          ...
          'Distance (pc)', '$\sigma_{sys}$', 'h (pc)', '$A_\lambda$ scale']
...
magobs = np.array([15.245, 14.617, 14.435, 14.330, 13.447, 13.039, 12.977,
                   12.959, 13.020])
magerr = np.array([0.003, 0.004, 0.003, 0.004, 0.024, 0.022, 0.032, 0.026,
                   0.029])
# extinction measure in each filter
maglam = np.array([0.359, 0.248, 0.184, 0.137, 0.078, 0.050, 0.034, 0.021,
                   0.016])
