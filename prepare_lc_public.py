# -*- coding: utf-8 -*-
"""
Created on Thu Mar 27 14:12:09 2014
...
def preparelc(KIC,dataloc=keplerdata,fill=True,
    ...
    Calls maskregion, so can optionally pass in kwargs appropriate to mask
    out certain regions of the data (known transits, etc).
    ...
    fill : boolean, optional
        ...
        interpolate times to all missing cadences and assign them 0
    ...
    ignorelist : string, optional
        ...
        adjusted by timeoffset). Defaults to the file listed in the
        module.
    ...
    if fill:
        ...
        # fill in the infinite flux errors with interpolated values to make plotting easier
