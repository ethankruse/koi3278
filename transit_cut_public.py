...
# get the light curve
time,flux,fluxerr,cad,quart,qual = preparelc(KIC,cutjumps=False,usepdc=usepdc,fill=True)
...
# will have to handle errors (e.g. transits near the beginning or end of observation before generalizing this)
if lorig != len(cads):
